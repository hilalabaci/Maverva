...
import { loginGoogle, loginVerificationEmail } from "../../../api/auth-api";
import Input from "../../ui/Input/round";
import { validateEmail } from "../../../utils/validation";
import ActionButton from "../../ui/Button/BaseButton";
...
function RegisterForm() {
  ...
  return (
    <Container>
      ...
      <GoogleSignWrapper>
        <GoogleAuthButton borderRadius="xl" />
      </GoogleSignWrapper>
    </Container>
  );
}
